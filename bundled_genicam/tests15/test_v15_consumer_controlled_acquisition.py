"""Acquisition test for the GenTL 1.5 binding using Consumer-allocated
buffers (`announce_buffer`), plus the safety guarantees around it:
rejecting immutable `bytes`, and keeping the backing memory alive/locked
